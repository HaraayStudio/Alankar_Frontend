                  ...
                  >
                    <div className={styles.clientName}>
                      ...
                      <svg
                        ...
                        fill="blue"
                      >
                        <rect width="42" height="42" rx="21" fill="#DAE7FC" />
                        <path
    ...
    <div className={styles.orderDetails}>
      <div>
        ...
        <div className={styles.orderInfo}>
          ...
          <div className={styles.infoRow}>
            <label>Created At</label>
            <span>{showValue(formatDate(selectedOrder.createdAtDateTime))}</span>
          </div>
          <div className={styles.infoRow}>
            <label>Start Date</label>
            <span>{showValue(formatDate(selectedOrder.startDateTime))}</span>
          ...
          {selectedOrder.steps && selectedOrder.steps.length > 0 ? (
            selectedOrder.steps.map((step, index) => (
              <div key={step.id || index} className={styles.stepItem}>
                ...
                <div className={styles.stepContent}>
                  <div className={styles.stepName}>{showValue(step.orderStepName || step.stepName)}</div>
                  <div className={styles.stepMeasurement}>{showValue(step.measurement)}</div>
                  <div
                    className={styles.stepStatus}
                    style={{
...
<div className={styles.paymentsCard}>
  <div className={styles.payHeader}>
    <div>
      <div className={styles.payTitle}>Payments</div>
      <div className={styles.payAmount}>{formatCurrency(totalPending)}</div>
      <span className={styles.payGrowth}>
        <span>Received: {formatCurrency(totalReceived)}</span>
      </span>
      <span className={styles.payGrowth}>
