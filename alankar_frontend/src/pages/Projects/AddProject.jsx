  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:8080/api/orders/createorder?isOldClient=${isOldClient}`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1c2VyQGdtYWlsLmNvbSIsInJvbGUiOiJBRE1JTiIsInVzZXJJZCI6MSwiaWF0IjoxNzQ5MTE2OTQ5LCJleHAiOjE3NDkyMDMzNDl9.ml2UeCWBDDvaVfY7FtOxMJhyrvAlA_oSZk7LxMt2kXY}`,
        },
        body: formDataToSend
      });
