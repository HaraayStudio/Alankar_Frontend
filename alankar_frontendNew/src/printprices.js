...
//           ],
//           Installation: [
//             { name: "Drilling on wall", cost: "30 PER SQFT" },
//             { name: "Pasting on site", cost: "20 PER SQFT" },
//             { name: "Rolled prints only", cost: "-" }
//           ],
//           Framing: [
//             { name: "No frame", cost: 0 },
//             { name: "Half inch frame", cost: "150 per sqft" },
//             { name: "1inch frame", cost: "170 per sqft" },
//             { name: "2inch Frame", cost: "230 per sqft" }
//           ]
//         },
//         "Solvent": {
//           Media: [
...
//     },
//     Online: {
//       // Copy data from Cash if same, or add different pricing if needed
//     },
//     Printers: {
//       // Copy data from Cash if same, or add different pricing if needed
//     }
    ...
    Cash: {
      orderTypes: {
        ...
        "Digital format printing": {
          printTypes: {
            // You can copy the printTypes from "Wide format printing" or add digital-specific data here.
            // Example: (copying same as wide format for now, update as needed)
            "Eco solvent": { /* ...same as above... */ },
            "Solvent": { /* ...same as above... */ },
            "UV Print": { /* ...same as above... */ },
            "Canon 12 colour": { /* ...same as above... */ }
          }
        }
      }
    },
    Online: {
      // If prices are the same as Cash, you can use: ...Cash,
      // If different, copy and update as needed.
      orderTypes: {
        "Wide format printing": {
          printTypes: {
            // You can copy or change as required.
            "Eco solvent": { /* ...same as Cash... */ },
            "Solvent": { /* ...same as Cash... */ },
            "UV Print": { /* ...same as Cash... */ },
            "Canon 12 colour": { /* ...same as Cash... */ }
          }
        },
        "Digital format printing": {
          printTypes: {
