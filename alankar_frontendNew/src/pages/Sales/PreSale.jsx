...
//   // Fake data (for demo) - use your real API
//   const FAKE_QUOTATIONS = [
//     { quotationId: 1, presaleSrNumber: 1, amount: 5000, note: "First quote", date: "2024-06-15" },
//     { quotationId: 2, presaleSrNumber: 2, amount: 3000, note: "Second quote", date: "2024-06-16" }
//   ];
// // Handler to open modal and show quotations
//   const handleOpenQuotationModal = (presale) => {
//     setSelectedQuotationPresale(presale);
//     setShowQuotationModal(true);
//     // Replace with API if you have
//     setQuotations(FAKE_QUOTATIONS.filter(q => q.presaleSrNumber === presale.srNumber));
//   };
//   const handleAddQuotation = (q) => {
//     setQuotations(prev => [
//       ...prev,
//       {
//         ...q,
//         quotationId: Date.now(),
//         presaleSrNumber: selectedQuotationPresale.srNumber,
//       }
//     ]);
//   };
// const defaultForm = {
...
//     "Started", "Ended", "Estimated Budget", "Quatation ","Status", "Conclusion", "Action"
//   ];
//   return (
//     <div className={styles.container}>  <QuotationPopup
...
// };
// const FAKE_QUOTATIONS = [
//   { quotationId: 1, presaleSrNumber: 1, amount: 5000, notes: "First quote", date: "2024-06-15" },
//   { quotationId: 2, presaleSrNumber: 2, amount: 3000, notes: "Second quote", date: "2024-06-16" }
// ];
// const PreSalesPage = () => {
//   const {
//     presales, presalesLoading, presalesError,
//     handleGetAllPresales, handleCreatePresale, handleUpdatePresaleStatus, handleDeletePresale,
//     clients
//   } = useData(); console.log("Presales Data:", presales);
//   // --- Quotation popup state (correct place!) ---
//   const [showQuotationModal, setShowQuotationModal] = useState(false);
//   const [selectedQuotationPresale, setSelectedQuotationPresale] = useState(null);
//   const [quotations, setQuotations] = useState([]);
//   // --- Other states ---
...
//     setSelectedQuotationPresale(presale);
//     setShowQuotationModal(true);
//     // Use your API here if available
//     setQuotations(FAKE_QUOTATIONS.filter(q => q.presaleSrNumber === presale.srNumber));
//   };
//   const handleAddQuotation = (q) => {
//     setQuotations(prev => [
...
//   const tableHeaders = [
//     "S.No", "Person Name", "Company name", "Requirement", "Approached via",
//     "Started", "Ended", "Estimated Budget", "Quotations", "Status", "Conclusion", "Action"
//   ];
//   return (
...
//               </select>
//               <div className={styles.formActions}>
//                 <button className={styles.submitBtn} onClick={handleUpdatePresaleStatus}>Update Status</button>
//               </div>
//             </div>
//           </div>
//         </div>
