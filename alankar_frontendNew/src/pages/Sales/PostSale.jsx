...
//     <th style={styles.th}>Order Description</th>
//     <th style={styles.th}>Order Start</th>
//     <th style={styles.th}>Order End</th>
//     <th style={styles.th}>Estimated Quote</th>
//     <th style={styles.th}>Negotiation Price</th>
//     <th style={styles.th}>Final Amt (No GST)</th>
//     <th style={styles.th}>GST %</th>
//     <th style={styles.th}>Total Amt (With GST)</th>
...
//     <tr key={item.srNumber || index}>
//       <td style={styles.td}>{item.srNumber || String(index + 1).padStart(2, '0')}</td>
//       <td style={styles.td}>{item.client?.clientName || '-'}</td>
//       <td style={styles.td}>{item.client?.email || '-'}</td>
//       <td style={styles.td}>{item.client?.phone || '-'}</td>
//       <td style={styles.td}>{item.order?.description || '-'}</td>
//       <td style={styles.td}>
...
//       </td>
//       <td style={styles.td}>
//         {item.estimatedQuote ? `₹${item.estimatedQuote.toLocaleString()}` : '-'}
//       </td>
//       <td style={styles.td}>
//         {item.negotiationPrice ? `₹${item.negotiationPrice.toLocaleString()}` : '-'}
//       </td>
//       <td style={styles.td}>
//         {item.finalAmtWithOutGST ? `₹${item.finalAmtWithOutGST.toLocaleString()}` : '-'}
//       </td>
//       <td style={styles.td}>
//         {item.gstPercentage ? `${item.gstPercentage}%` : '-'}
//       </td>
//       <td style={styles.td}>
//         {item.totalAmtWithGST ? `₹${item.totalAmtWithGST.toLocaleString()}` : '-'}
//       </td>
//       <td style={styles.td}>
